...
test "reference repo" {
    ...
    std.debug.print("Starting finite_fields loop\n", .{});
    inline for (finite_fields) |F| {
        ...
        std.debug.print("Testing vector...\n", .{});
    ...
    std.debug.print("Reference repo test completed successfully\n", .{});
}

test "finite field implementation coherency" {
    std.debug.print("\n*** Running finite field implementation coherency test ***\n", .{});
    ...
    std.debug.print("Starting 10,000 iterations...\n", .{});
    for (0..10_000) |_| {
    ...
    std.debug.print("Ending 10,000 iterations...\n", .{});
    std.debug.print("Coherency test completed successfully\n", .{});
}
